...
for (let index in programmers) {
  console.log(
    `${index}: ${programmers[index].name} ${programmers[index].lastname}, su aporte fue ${programmers[index].knowledge}`,
  );
}
